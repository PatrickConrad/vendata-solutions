...
export const getConsultationPinServer = async (email: string, captcha: string ) => {
    if (!email || !captcha) {
...
export const requestConsultationPinServer = async (email:string) => { 
  console.log({email})
...
export const verifyPinServer = (email: string, pin: string)=>{
