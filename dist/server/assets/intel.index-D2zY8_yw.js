import { n as jsxRuntimeExports, a as reactExports } from "./worker-entry-B-ccKcau.js";
import { D as Divider } from "./Divider-C7nOp_YO.js";
import { L as Link, R as Route } from "./router-WRanMyea.js";
import "node:events";
...
function BlogIndex() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen w-full bg-white dark:bg-slate-900 px-6 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full lg:max-w-[50%] mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl font-extrabold text-(--v-navy) dark:text-(--v-gold) mb-4", children: "Vendata Intel" }),
