import { y as notImplementedClass, z as notImplemented, A as notImplementedAsync, B as getAugmentedNamespace, C as getDefaultExportFromCjs, x as createServerRpc, s as createServerFn } from "./worker-entry-Cp1SBzdi.js";
import crypto from "crypto";
import require$$0$6 from "events";
import require$$0$2 from "url";
import require$$1$1 from "util";
import { u as utimes$1, a as unlink$1, t as truncate$1, s as symlink$1, b as statfs$1, c as stat$1, r as rmdir$1, d as rm$1, e as rename$1, f as realpath$1, g as readlink$1, h as readdir$1, i as readFile$1, o as opendir$1, j as open$1, m as mkdtemp$1, k as mkdir$1, l as lutimes$1, n as lstat$1, q as link$1, v as lchown$1, w as lchmod$1, x as cp$1, y as copyFile$1, z as chown$1, A as chmod$1, B as appendFile$1, C as access$1, D as writeFile$1, p as promises, E as constants$1, X as X_OK, W as W_OK, R as R_OK, F as F_OK } from "./promises-d4a02vTq.js";
...
var nodemailer$1 = {};
var shared = { exports: {} };
const require$$4$1 = /* @__PURE__ */ getAugmentedNamespace(fs$1);
var fetch = { exports: {} };
var cookies;
...
const require$$4 = /* @__PURE__ */ getAugmentedNamespace(os$1);
...
function requireShared() {
  ...
  (function(module) {
    ...
    const fs2 = require$$4$1;
    const nmfetch = requireFetch();
    const dns = require$$4$2;
    const net = require$$7;
    const os2 = require$$4;
    ...
    let networkInterfaces2;
    try {
      networkInterfaces2 = os2.networkInterfaces();
    } catch (_err) {
    }
    ...
    const resolver = (family, hostname2, options, callback) => {
      options = options || {};
...
function requireSign() {
  ...
  sign.exports = (headers, hashAlgo, bodyHash, options) => {
    ...
    signer = crypto$1.createSign(("rsa-" + hashAlgo).toUpperCase());
    ...
    _convertDataImages(mail, callback) {
      ...
      mail.resolveContent(mail.data, "html", (err, html) => {
        ...
        html = (html || "").toString().replace(/(<img\b[^<>]{0,1024} src\s{0,20}=[\s"']{0,20})(data:([^;]+);[^"'>\s]+)/gi, (match, prefix, dataUri, mimeType) => {
          let cid = crypto$1.randomBytes(10).toString("hex") + "@localhost";
...
const getConsultationPin_createServerFn_handler = createServerRpc("9ea599125807398ba191be13f1b9a434a3e5b3c1d068ccfa3fa6f7b35d072438", (opts, signal) => getConsultationPin.__executeServer(opts, signal));
...
const requestConsultationPin_createServerFn_handler = createServerRpc("aafd0cdacef481a67035b1d6146796e1b93f2ae503d925868a8f718cfa71e9ba", (opts, signal) => requestConsultationPin.__executeServer(opts, signal));
...
const verifyPin_createServerFn_handler = createServerRpc("8624f41f9704bb63fd04683d56d305078698bebf767554f65b2bc2e2bd0ad490", (opts, signal) => verifyPin.__executeServer(opts, signal));
...
export {
  ...
  requestConsultationPin_createServerFn_handler,
  verifyPin_createServerFn_handler
};
