...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v--KKuhByR.js");
...
const manifest = { "7d7e857e3252f6ecf0c7eabed1b93b93ea9bc14341b78a5c25ea74735091c89a": {
  ...
  importer: () => import("./content-C5_Ob9RX.js")
  ...
  importer: () => import("./email-BcYrUxz2.js")
  ...
  importer: () => import("./email-BcYrUxz2.js")
}, "aed5074db655da91215f09f7f9fe1852eb513595fd1ada9d8406111e91ab3210": {
  functionName: "addEmailUser_createServerFn_handler",
  importer: () => import("./google-a1O5VTn7.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-CdQ98coo.js").then((n) => n.B);
    }
    if (startEntry === null) {
