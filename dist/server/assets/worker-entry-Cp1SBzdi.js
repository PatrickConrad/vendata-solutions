...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CI54vd-Q.js");
...
const manifest = { "779065a854cd3c8a83fc1f6d279993fb0c1460e9882d64d8e4a9c5d1a7f37ab0": {
  functionName: "getCount_createServerFn_handler",
  importer: () => import("./index-B6DTdyaP.js")
}, "4a6fc7c69795985fd86cb3abcfb13c573bafe2093c0f67aaee631bf215685906": {
  functionName: "updateCount_createServerFn_handler",
  importer: () => import("./index-B6DTdyaP.js")
}, "1fdd1544e24fb8c5d6161876b4645b1875249633f40d8a3f2179b16677831153": {
  functionName: "getPost_createServerFn_handler",
  importer: () => import("./BlogPosts-CRN9mZsH.js")
}, "9ea599125807398ba191be13f1b9a434a3e5b3c1d068ccfa3fa6f7b35d072438": {
  functionName: "getConsultationPin_createServerFn_handler",
  importer: () => import("./EmailPin-Bh5lxVCq.js")
}, "aafd0cdacef481a67035b1d6146796e1b93f2ae503d925868a8f718cfa71e9ba": {
  functionName: "requestConsultationPin_createServerFn_handler",
  importer: () => import("./EmailPin-Bh5lxVCq.js")
}, "8624f41f9704bb63fd04683d56d305078698bebf767554f65b2bc2e2bd0ad490": {
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-_ciCvpq_.js").then((n) => n.r);
    }
    if (startEntry === null) {
