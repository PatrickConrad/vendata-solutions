...
const MobileMenu = ({ open, onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ref: menuRef,
      className: `min-[1020px]:hidden bg-white border-t border-b border-gray-500 overflow-hidden transition-all duration-300 ${open ? "max-h-105 opacity-100" : "max-h-0 opacity-0"}`,
...
const DesktopMenu = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden min-[1020px]:flex items-center gap-8 font-bold text-v-navy/70", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "hover:text-(--v-gold) transition", children: "Home" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/consultation", className: "btn-gold  py-2.5 rounded-lg text-sm px-3", children: "Start Working Smarter" }),
...
const FooterResources = ({ className }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${className ?? "text-center"}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 text-sm md:text-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/insights", className: "hover:text-(--v-gold) transition", children: "Insights" }) }),
...
const FooterCompany = ({ className }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${className ?? "text-center"}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 text-sm md:text-lg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/our-work", className: "hover:text-(--v-gold) transition", children: "Our Work" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {})
  ] });
};
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("html", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AppProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("head", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeadContent, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { className: "text-slate-200", children: [
...
const $$splitComponentImporter$f = () => import("./terms-CyaG0Smz.js");
...
const $$splitComponentImporter$e = () => import("./privacy-N_WWMCWC.js");
const Route$e = createFileRoute("/privacy")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./our-work-BLo9N53o.js");
const Route$d = createFileRoute("/our-work")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./insights-DwcoKy-Z.js");
const Route$c = createFileRoute("/insights")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./contact-B6RSUvEB.js");
...
const $$splitComponentImporter$a = () => import("./auth-DiJ3olQQ.js");
...
const $$splitComponentImporter$9 = () => import("./app-CVOfqrH-.js");
...
const $$splitComponentImporter$8 = () => import("./about-EoHo48aJ.js");
...
const $$splitComponentImporter$7 = () => import("./_404-tREKG7Xy.js");
...
const $$splitComponentImporter$6 = () => import("./index-6YCEgW8I.js");
...
const $$splitComponentImporter$5 = () => import("./insights.index--DU7nfIQ.js");
...
const $$splitComponentImporter$4 = () => import("./index-DvfpEzkD.js");
...
const $$splitNotFoundComponentImporter = () => import("./insights._postId-BuYwg1Cp.js");
const $$splitComponentImporter$3 = () => import("./insights._postId-tmPIKgv3.js");
...
const $$splitComponentImporter$2 = () => import("./book-CimAagHs.js");
const Route$2 = createFileRoute("/consultation/book")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./app.dashboard-CQwxUIkj.js");
const Route$1 = createFileRoute("/app/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./app._layout-Bp_QemcF.js");
