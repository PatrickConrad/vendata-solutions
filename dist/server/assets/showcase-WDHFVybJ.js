...
import { a as faCartFlatbed, b as faUtensils, c as faDumbbell, F as FontAwesomeIcon, L as Link } from "./router-CdQ98coo.js";
...
function CaseStudiesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-slate-900 transition-colors duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MatrixBackground, { height: "30vh", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center z-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-24 px-6 bg-v-navy text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services/diagnostics", className: "btn-gold px-10 py-4 rounded-xl font-black uppercase", children: "Work with Vendata" }) })
    ] })
  ] });
}
